...
// The insertFixUp function is used to adjust the red-black tree after inserting a node to maintain the properties of the red-black tree
...
// The deleteFixUp function is used to adjust the red-black tree after deleting a node to maintain the properties of the red-black tree
...
func (tree *RBTree) minimum(node *Node) *Node {
...
func (tree *RBTree) maximum(node *Node) *Node {
...
func (tree *RBTree) successor(node *Node) *Node {
...
func (tree *RBTree) Range(fn func(*Node) bool) {

	// 对红黑树的根节点进行中序遍历
	// Traverse the root of the red-black tree in order
...
func (tree *RBTree) Push(node *Node) {
